  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 pb-10">
      <div className="flex items-center gap-4">
        <button 
          onClick={() => navigate(-1)}
          className="w-10 h-10 flex items-center justify-center bg-[#F6F8FB] border border-[#E1E6EE] rounded-lg hover:bg-[#3E4FFF] hover:text-white transition-colors text-[#4B5563]"
        >
