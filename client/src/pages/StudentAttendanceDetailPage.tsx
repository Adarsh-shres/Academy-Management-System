...
export default function StudentAttendanceDetailPage() {
    ...
    return (
      <div className="flex flex-col gap-6 pb-10 max-w-[900px] mx-auto w-full">
        <button
          ...
          className="flex items-center gap-2 text-[13px] font-semibold text-[#4B5563] hover:text-[#232529] transition-colors w-fit"
        >
        ...
        <div className="bg-white rounded-[12px] border border-[#E1E6EE] p-10 text-center flex flex-col items-center">
          ...
          <h3 className="text-[18px] font-bold text-[#232529] mb-1">Class Not Found</h3>
  ...
  return (
    <div className="flex flex-col gap-6 pb-10 max-w-[900px] mx-auto w-full">
      ...
      <button
        onClick={() => navigate("/student/attendance")}
        className="flex items-center gap-2 text-[13px] font-semibold text-[#4B5563] hover:text-[#232529] transition-colors w-fit cursor-pointer group"
      >
      ...
      {/* Class Info Header */}
      <div className="bg-white rounded-[12px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.04)] overflow-hidden">
        <div className="h-1.5 w-full" style={{ backgroundColor: color }} />
        <div className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div>
              <span className="inline-block text-[10.5px] font-semibold px-2 py-0.5 rounded-[6px] text-[#4B5563] bg-[#F6F8FB] uppercase tracking-wide mb-2">
                {courseCode}
              </span>
              <h1 className="font-sans text-[22px] md:text-[24px] font-bold text-[#232529] tracking-tight leading-tight">
                {courseName}
              </h1>
            ...
            <div className="flex items-center gap-3 sm:flex-col sm:items-end">
              <div className="font-sans text-[32px] font-bold text-[#232529] leading-none">
                {attendancePercent}
            ...
            <div className="w-full h-[6px] bg-[#efe8f5] rounded-full overflow-hidden">
              <div
                ...
                style={{
                  ...
                  backgroundColor: attendancePercent >= 80 ? "#3E4FFF" : "#e11d48",
                }}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center py-3 bg-[#faf8fc] rounded-[8px] border border-[#E1E6EE]">
              <p className="font-sans text-[20px] font-bold text-[#232529] leading-none mb-1">{totalSessions}</p>
      ...
      <div className="flex items-center justify-between">
        <h2 className="font-sans text-[18px] font-bold text-[#232529] tracking-tight">
          Session Records
        </h2>
        <span className="rounded-full bg-[#F6F8FB] px-3 py-1 text-[11px] font-bold text-[#4B5563] uppercase tracking-wider">
      ...
      {records.length > 0 ? (
        Object.entries(groupedByMonth).map(([month, monthRecords]) => (
          <div key={month} className="bg-white rounded-[12px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.04)] overflow-hidden">
            <div className="px-5 py-3 bg-[#F6F8FB] border-b border-[#E1E6EE] flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#3E4FFF" strokeWidth="2">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2" />
                <line x1="16" y1="2" x2="16" y2="6" />
                <line x1="8" y1="2" x2="8" y2="6" />
                <line x1="3" y1="10" x2="21" y2="10" />
              </svg>
              <h3 className="text-[13px] font-bold text-[#232529] uppercase tracking-wide">{month}</h3>
        ...
        <div className="bg-white rounded-[12px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.04)] p-10 text-center flex flex-col items-center">
          <div className="w-14 h-14 rounded-full bg-[#F6F8FB] flex items-center justify-center mb-4 text-[#4B5563]">
          ...
          <h3 className="text-[18px] font-bold text-[#232529] mb-1">No Sessions Recorded</h3>
          <p className="text-[14px] text-[#7c8697] max-w-md">
