  ...
  return (
    <div className="flex flex-col gap-8 pb-10 flex-1 min-w-0 max-w-[1100px] mx-auto w-full">
      ...
      {isLoading ? (
        ...
        <div className="flex h-[200px] items-center justify-center text-[#232529] font-semibold">
          {error}
        </div>
      ) : (
        <>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
        {/* Search */}
        <div className="flex-1 flex items-center gap-2 bg-white border border-[#E1E6EE] rounded-[8px] px-4 py-2.5 shadow-[0_1px_4px_rgba(36,37,41,0.02)] transition-shadow focus-within:shadow-[0_2px_10px_rgba(36,37,41,0.06)] focus-within:border-[#E1E6EE] w-full">
          ...
          <input
            ...
            className="flex-1 text-[13px] text-[#232529] placeholder-[#cbd5e1] outline-none bg-transparent font-medium"
          />
          {search && (
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto overflow-x-auto">
          {/* Subject Dropdown */}
          <div className="bg-white border border-[#E1E6EE] rounded-[8px] px-3 flex items-center shadow-[0_1px_4px_rgba(36,37,41,0.02)] w-full sm:w-auto shrink-0">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-[#B7C0CB] mr-2 shrink-0">
          ...
          {/* Filter pills */}
          <div className="flex gap-2 bg-white border border-[#E1E6EE] rounded-[8px] p-1.5 shadow-[0_1px_4px_rgba(36,37,41,0.02)] w-full sm:w-auto overflow-x-auto shrink-0">
            ...
            >
              ...
              <span
                className={`text-[10px] px-2 py-[2px] rounded-full font-semibold ${
                  filter === opt.value ? "bg-white/20 text-white" : "bg-[#F6F8FB] text-[#232529]"
                }`}
              >
                {opt.count}
              </span>
    ...
    {/* Grouped Assignments Content */}
      <div className="flex flex-col gap-8 mt-2">
        {Object.entries(groupedAssignments).map(([subject, assignmentsInSubject]) => (
          <div key={subject} className="space-y-4">
            <div className="flex items-center gap-3">
              <h3 className="font-sans text-[19px] md:text-[21px] font-bold text-[#232529] tracking-tight">{subject}</h3>
        ...
        {Object.keys(groupedAssignments).length === 0 && (
          <div className="bg-white rounded-[10px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.02)] p-10 text-center">
