    ...
    <div className="flex flex-col gap-6 md:gap-8 pb-10">
      ...
      <section className="bg-white rounded-sm border border-[#e2e8f0] shadow-sm overflow-hidden max-w-4xl">
        <div className="px-5 py-4 border-b border-[#e2e8f0] bg-[#F6F8FB]">
          <h2 className="text-[#232529] font-bold text-[13px] uppercase tracking-wide">Batch</h2>
        </div>
        ...
        <div className="p-5 grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-5">
          ...
          <div className="rounded-sm border border-[#e2e8f0] bg-[#f8fafc] p-4">
            <h3 className="text-[12px] font-bold text-[#232529] uppercase tracking-wide">Selected Batch</h3>
            {selectedBatch ? (
        ...
        <div className="px-5 py-4 border-t border-[#e2e8f0] bg-[#F6F8FB] flex justify-end gap-3">
          <button type="button" onClick={() => navigate('/classes')} className="px-5 py-2.5 bg-white border border-[#E1E6EE] text-[#232529] text-[13.5px] font-semibold rounded-sm hover:bg-[#F6F8FB] transition-all cursor-pointer">
            Cancel
          </button>
          <button type="button" onClick={continueToClassForm} disabled={!selectedBatchId} className="px-6 py-2.5 bg-[#3E4FFF] hover:bg-[#5F73F5] text-white text-[13.5px] font-semibold rounded-sm transition-all shadow-sm cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed">
            Continue
          </button>
        </div>
      </section>
