...
import { type User, ROLES } from '../data/users.ts';
                ...
                <section className="grid gap-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <UserField label="Temporary Password">
                      <UserInput value={newPassword} onChange={setNewPassword} placeholder="Minimum 8 characters" type="password" minLength={8} required />
                    </UserField>
