        ...
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-white border border-[#E1E6EE] text-[#232529] text-[13.5px] font-bold px-5 py-2.5 rounded-sm hover:bg-[#F6F8FB] transition-all cursor-pointer"
            >
              Edit Batch
            </button>
            <button
          ...
          <div className="flex flex-col gap-6">
            <section className="bg-white rounded-sm border border-[#e2e8f0] shadow-sm overflow-hidden">
              <div className="px-5 py-4 border-b border-[#e2e8f0] bg-[#F6F8FB]">
                <h2 className="text-[#232529] font-bold text-[13px] uppercase tracking-wide">Batch Summary</h2>
              </div>
              <div className="p-5 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[11px] font-bold text-[#64748b] uppercase tracking-wider mb-1">Students</p>
                  <p className="text-[24px] font-extrabold text-[#4B5563] leading-none">{assignedStudents.length}</p>
                </div>
                <div>
                  <p className="text-[11px] font-bold text-[#64748b] uppercase tracking-wider mb-1">Courses</p>
                  <p className="text-[24px] font-extrabold text-[#4B5563] leading-none">{assignedCourses.length}</p>
                </div>
            ...
            <section className="bg-white rounded-sm border border-[#e2e8f0] shadow-sm overflow-hidden">
              <div className="px-5 py-4 border-b border-[#e2e8f0] bg-[#F6F8FB]">
                <h2 className="text-[#232529] font-bold text-[13px] uppercase tracking-wide">Assigned Courses</h2>
              </div>
          ...
          <section className="bg-white rounded-sm border border-[#e2e8f0] shadow-sm overflow-hidden">
            ...
            {assignedStudents.length > 0 ? (
                      ...
                      >
                        ...
                        <td className="py-4 px-6">
                          <div className="flex items-center gap-3">
                            ...
                            <p className="text-[14px] font-bold text-[#1e293b] group-hover:text-[#4B5563] group-hover:underline underline-offset-4 transition-colors">{fullName(student)}</p>
                          </div>
                        </td>
              ...
              <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
                ...
                <h3 className="text-[18px] font-bold text-[#232529] mb-1">No Students Added</h3>
        ...
        <AppModal onClose={() => setIsSelectOpen(false)} widthClass="max-w-[920px]">
          <div className="bg-white rounded-md shadow-2xl overflow-hidden">
                ...
                <div className="p-4 border-b border-[#e2e8f0] bg-[#F6F8FB]">
                  <div className="flex items-center justify-between gap-3 mb-3">
                    ...
                    <button
                      ...
                      className="text-[12px] font-bold text-[#4B5563] hover:text-[#232529] cursor-pointer disabled:cursor-not-allowed disabled:text-[#cbd5e1]"
                    >
                      Select All
                    </button>
                  </div>
                  <input
                    ...
                    className="bg-white border border-[#cbd5e1] rounded-sm px-4 py-2.5 text-[14px] w-full outline-none focus:border-[#CCD4E0] focus:ring-2 focus:ring-[#CCD4E0]/10 transition-all text-[#1e293b]"
                  />
                </div>
            ...
            <div className="px-6 py-4 border-t border-[#e2e8f0] bg-[#F6F8FB] flex justify-end gap-3">
              <button type="button" onClick={() => setIsSelectOpen(false)} disabled={isSaving} className="px-5 py-2.5 bg-white border border-[#E1E6EE] text-[#232529] text-[13.5px] font-semibold rounded-sm hover:bg-[#F6F8FB] transition-all cursor-pointer disabled:opacity-60">
                Cancel
              </button>
              <button type="button" onClick={handleSaveSelectedStudents} disabled={isSaving} className="px-6 py-2.5 bg-[#3E4FFF] hover:bg-[#5F73F5] text-white text-[13.5px] font-semibold rounded-sm transition-all shadow-sm flex items-center gap-2 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed">
      ...
      {isEditOpen && (
        <AppModal onClose={() => setIsEditOpen(false)} widthClass="max-w-[760px]">
          <div className="bg-white rounded-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-6">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input value={editName} onChange={(event) => setEditName(event.target.value)} className="bg-[#f8fafc] border border-[#cbd5e1] rounded-sm px-4 py-2.5 text-[14px] w-full outline-none focus:border-[#CCD4E0] focus:ring-2 focus:ring-[#CCD4E0]/10 text-[#1e293b]" />
                </div>
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="flex bg-[#f8fafc] rounded-sm p-1 gap-1 border border-[#cbd5e1] w-full">
                    <button type="button" onClick={() => setEditStatus('Active')} className={`flex-1 rounded-sm py-1.5 text-[13px] transition-all cursor-pointer ${editStatus === 'Active' ? 'bg-white font-semibold text-[#4B5563] shadow-sm border border-[#e2e8f0]' : 'font-medium text-[#64748b] hover:text-[#232529]'}`}>
                      Active
                    </button>
                    <button type="button" onClick={() => setEditStatus('Archived')} className={`flex-1 rounded-sm py-1.5 text-[13px] transition-all cursor-pointer ${editStatus === 'Archived' ? 'bg-white font-semibold text-[#4B5563] shadow-sm border border-[#e2e8f0]' : 'font-medium text-[#64748b] hover:text-[#232529]'}`}>
                      Archived
                    </button>
                  </div>
                </div>
                <div className="flex flex-col gap-1.5">
                  ...
                  <textarea value={editDescription} onChange={(event) => setEditDescription(event.target.value)} rows={5} className="bg-[#f8fafc] border border-[#cbd5e1] rounded-sm px-4 py-3 text-[14px] w-full outline-none focus:border-[#CCD4E0] focus:ring-2 focus:ring-[#CCD4E0]/10 text-[#1e293b] resize-none" />
                </div>
              </div>
                  ...
                  {courses.map((course) => {
                    ...
                    return (
                      <label key={course.id} className="flex items-start gap-3 px-4 py-3 hover:bg-[#f8fafc] transition-colors cursor-pointer">
                        <input type="checkbox" checked={isSelected} onChange={() => toggleEditCourse(course.id)} className="mt-1 w-4 h-4 accent-[#3E4FFF]" />
                        <span className="min-w-0">
            ...
            <div className="px-6 py-4 border-t border-[#e2e8f0] bg-[#F6F8FB] flex justify-end gap-3">
              <button type="button" onClick={() => setIsEditOpen(false)} disabled={isSaving} className="px-5 py-2.5 bg-white border border-[#E1E6EE] text-[#232529] text-[13.5px] font-semibold rounded-sm hover:bg-[#F6F8FB] transition-all cursor-pointer disabled:opacity-60">
                Cancel
              </button>
              <button type="button" onClick={() => void handleSaveBatch()} disabled={isSaving} className="px-6 py-2.5 bg-[#3E4FFF] hover:bg-[#5F73F5] text-white text-[13.5px] font-semibold rounded-sm transition-all shadow-sm cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed">
      ...
      {isImportOpen && (
        <AppModal onClose={() => setIsImportOpen(false)} widthClass="max-w-[620px]">
          <div className="bg-white rounded-md shadow-2xl overflow-hidden">
            ...
            <div className="p-6 flex flex-col gap-5">
              <div className="flex justify-end">
                <button
                  ...
                  className="rounded-sm border border-[#E1E6EE] bg-white px-4 py-2 text-[13px] font-bold text-[#4B5563] transition-all hover:bg-[#F6F8FB]"
                >
                  Download Template
                </button>
              </div>

              <label className="flex flex-col items-center justify-center gap-3 rounded-sm border-2 border-dashed border-[#E1E6EE] bg-[#F6F8FB] px-6 py-10 text-center cursor-pointer hover:bg-[#F6F8FB] transition-colors">
                <input
                  ref={fileInputRef}
                  type="file"
                  accept=".csv,text/csv"
                  ...
                  className="sr-only"
                />
                <span className="w-12 h-12 rounded-full bg-white border border-[#E1E6EE] flex items-center justify-center text-[#4B5563]">
                ...
                <span>
                  <span className="block text-[14px] font-extrabold text-[#232529]">Choose CSV file</span>
            ...
            <div className="px-6 py-4 border-t border-[#e2e8f0] bg-[#F6F8FB] flex justify-end gap-3">
              <button type="button" onClick={() => setIsImportOpen(false)} disabled={isSaving} className="px-5 py-2.5 bg-white border border-[#E1E6EE] text-[#232529] text-[13.5px] font-semibold rounded-sm hover:bg-[#F6F8FB] transition-all cursor-pointer disabled:opacity-60">
                Cancel
              </button>
              <button
                type="button"
