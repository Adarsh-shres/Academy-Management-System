...
export default function TeacherClassesPage() {
  ...
  return (
    <div className="flex-1 p-6 md:p-8 flex flex-col min-w-0 max-w-[1400px] mx-auto w-full">
      {/* Header section */}
      <div className="mb-8">
        <h1 className="text-[26px] font-extrabold text-[#232529] tracking-tight">My Courses</h1>
      ...
      {isLoading ? (
            ...
            return (
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="text-[18px] font-bold text-[#232529] mb-2 leading-tight">{course.courses?.name || course.name}</h3>
        ...
        <div className="flex flex-col items-center justify-center py-20 px-4 bg-white border border-dashed border-[#E1E6EE] rounded-sm w-full text-center">
          ...
          <h2 className="text-[18px] font-bold text-[#232529] mb-1">No Classes Assigned</h2>
