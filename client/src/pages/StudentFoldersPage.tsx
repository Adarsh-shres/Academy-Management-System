    ...
    <div className="flex flex-col gap-8 pb-10 flex-1 min-w-0 max-w-[1100px] mx-auto w-full animate-in fade-in duration-200">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 rounded-[8px] border border-[#E1E6EE] bg-white px-4 py-2 text-[13px] font-medium text-[#232529] shadow-sm w-fit">
      ...
      {folders.length === 0 ? (
        <div className="rounded-[10px] border border-dashed border-[#E1E6EE] bg-white p-12 text-center shadow-[0_2px_12px_rgba(36,37,41,0.04)]">
          <h3 className="text-[16px] font-bold text-[#232529]">No folders yet</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {folders.map((folder) => (
            <Link
              ...
              className="group rounded-[10px] border border-[#E1E6EE] bg-white p-5 shadow-[0_2px_12px_rgba(36,37,41,0.04)] hover:shadow-[0_8px_24px_rgba(36,37,41,0.08)] transition-all"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="w-11 h-11 rounded-[8px] bg-[#F6F8FB] text-primary flex items-center justify-center shrink-0">
                  <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                  </svg>
                </div>
                <span className="text-[12px] font-semibold px-2 py-[3px] rounded-[6px] border text-primary bg-[#F6F8FB] border-[#E1E6EE]">
                  {folder.itemCount} {folder.itemCount === 1 ? "item" : "items"}
                </span>
              </div>
              <h3 className="font-sans text-[17px] font-bold text-[#232529] mt-5 group-hover:text-primary transition-colors">{folder.title}</h3>
