    ...
    <div className="app-shell flex h-screen font-sans overflow-hidden">
      ...
      <main className="app-main flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <div className="p-8 max-w-4xl mx-auto w-full">
          <h1 className="text-2xl font-extrabold text-[#232529] tracking-tight mb-2">Settings</h1>
          <p className="text-[14px] text-[#7c8697] mb-8">Manage your account settings and preferences</p>

          {/* Profile Information Card */}
          <div className="bg-white rounded-[10px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.02)] p-8 mb-6">
            <h2 className="font-sans text-[19px] font-bold text-[#232529] tracking-tight mb-6">Profile Information</h2>

            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-[#F6F8FB]">
                <div>
                  <p className="text-[13px] font-semibold text-[#778196] uppercase tracking-wider mb-1">Full Name</p>
                  <p className="text-[14px] font-medium text-[#232529]">{user?.name || 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between py-3 border-b border-[#F6F8FB]">
                <div>
                  ...
                  <p className="text-[14px] font-medium text-[#232529]">{user?.email || 'N/A'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between py-3">
                <div>
                  ...
                  <p className="text-[14px] font-medium text-[#232529] capitalize">{user?.role || 'N/A'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[10px] border border-[#E1E6EE] shadow-[0_2px_12px_rgba(36,37,41,0.02)] p-8">
            <h2 className="font-sans text-[19px] font-bold text-[#232529] tracking-tight mb-6">Security</h2>

            <div className="flex items-center justify-between p-4 bg-[#F8FAFC] rounded-[8px] border border-[#E1E6EE]">
              <div>
              ...
              <button
                ...
                className="text-[11.5px] font-semibold text-white bg-[#3E4FFF] hover:bg-[#5F73F5] px-4 py-2.5 rounded-[6px] uppercase tracking-wider transition-colors border border-transparent cursor-pointer whitespace-nowrap ml-4"
              >
                Update
              </button>
            </div>
