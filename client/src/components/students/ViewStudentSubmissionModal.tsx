    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-md w-full max-w-[500px] shadow-2xl flex flex-col max-h-[90vh]">
        <div className="p-5 border-b border-[#E1E6EE] flex justify-between items-center bg-[#F6F8FB] rounded-t-md">
          <h3 className="text-[18px] font-bold text-[#232529]">Submission Report</h3>
        ...
        <div className="p-6 overflow-y-auto w-full hide-scrollbar flex flex-col gap-5">
          <div>
            <h4 className="text-[16px] font-bold text-[#232529] mb-1">{assignment.title}</h4>
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              <span className="text-[11px] font-semibold px-2.5 py-1 uppercase tracking-wide rounded-full text-primary bg-[#F6F8FB] border border-[#E1E6EE]">
                Submitted
              </span>
          ...
          <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-[8px] p-4 flex flex-col gap-4">
            <div className="flex justify-between items-center border-b border-[#e2e8f0] pb-3">
              ...
              <span className="text-[15px] font-bold text-[#232529]">
            ...
            <div className="flex justify-between items-center border-b border-[#e2e8f0] pb-3">
              ...
              <span className="text-[15px] font-bold text-[#232529]">{gradeStatusLabel}</span>
            </div>
            <div className="border-b border-[#e2e8f0] pb-3">
              <span className="text-[13px] font-bold text-[#64748b] uppercase tracking-wider">Teacher Remarks</span>
              <p className="mt-2 text-[13px] font-medium text-[#232529] leading-relaxed">
