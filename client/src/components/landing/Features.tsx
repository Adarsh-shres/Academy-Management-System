  ...
  return (
    <section className="flex flex-col gap-12 mt-12" id="features">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1 bg-white p-8 rounded-sm shadow-[0_10px_28px_rgba(36,37,41,0.06)] border border-[#E1E6EE]">
                <h3 className="text-[12px] font-bold text-primary uppercase tracking-[0.08em] mb-4 pb-3 border-b border-[#E1E6EE]">Personalized Student Dashboard</h3>
            ...
            <div className="flex-1">
                ...
                <h2 className="text-[32px] font-extrabold text-[#232529] mb-4 tracking-tight">Student Dashboard</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1">
                ...
                <h2 className="text-[32px] font-extrabold text-[#232529] mb-4 tracking-tight">To-Do List</h2>
                <p className="text-[15px] text-[#7c8697] leading-relaxed">
            ...
            <div className="flex-1 bg-white p-8 rounded-sm shadow-[0_10px_28px_rgba(36,37,41,0.06)] border border-[#E1E6EE]">
                <h3 className="text-[12px] font-bold text-primary uppercase tracking-[0.08em] mb-4 pb-3 border-b border-[#E1E6EE]">Organized Task List</h3>
