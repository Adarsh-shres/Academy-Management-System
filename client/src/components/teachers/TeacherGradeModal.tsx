    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-md w-full max-w-[500px] shadow-2xl flex flex-col max-h-[90vh]">
        <div className="p-5 border-b border-[#E1E6EE] flex justify-between items-center bg-[#F6F8FB] rounded-t-md">
          <h3 className="text-[18px] font-bold text-[#232529]">Grade Submission</h3>
          <button 
            onClick={onClose} 
            className="text-[#94a3b8] hover:text-[#232529] transition-colors cursor-pointer bg-white rounded-full p-1 border border-[#E1E6EE]"
          >
          ...
          <form id="grading-form" onSubmit={handleSaveGrade} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5 pt-2 border-t border-[#e2e8f0]">
               ...
               {submission.file_url ? (
                  ...
                  >
                     <div className="flex items-center justify-center w-8 h-8 rounded-sm bg-[#F6F8FB] text-[#4B5563] group-hover:bg-[#3E4FFF] group-hover:text-white transition-colors">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                     </div>
                     <span className="text-[13.5px] font-bold text-[#4B5563] group-hover:underline">View Attachment Target / Solution</span>
                  </a>
               ) : (
            ...
            <div className="flex flex-col gap-1.5 pt-4 border-t border-[#e2e8f0]">
              ...
              <div className="relative w-1/2">
                <select
                  ...
                  className="bg-white border border-[#cbd5e1] rounded-sm px-4 py-2.5 text-[14px] font-bold text-[#232529] outline-none focus:border-[#CCD4E0] focus:ring-[3px] focus:ring-[#CCD4E0]/10 transition-all w-full appearance-none cursor-pointer"
                  required
                >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea 
                ...
                className="bg-white border border-[#cbd5e1] rounded-sm px-4 py-3 text-[13.5px] w-full outline-none focus:border-[#CCD4E0] focus:ring-[3px] focus:ring-[#CCD4E0]/10 transition-all text-[#1e293b] resize-none"
              />
            </div>
          </form>
        </div>
        ...
        <div className="p-5 border-t border-[#E1E6EE] bg-[#F6F8FB] flex justify-end gap-3 rounded-b-md">
           ...
           <button 
             ...
             form="grading-form"
             disabled={isSaving}
             className="px-6 py-2.5 bg-[#3E4FFF] hover:bg-[#5F73F5] text-white text-[13.5px] font-bold tracking-wide rounded-sm transition-all shadow-sm cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
           >
