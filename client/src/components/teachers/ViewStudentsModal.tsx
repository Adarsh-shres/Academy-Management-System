    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 bg-white rounded-md w-full max-w-[600px] shadow-2xl flex flex-col max-h-[90vh]">
        <div className="p-5 border-b border-[#E1E6EE] flex justify-between items-center bg-[#F6F8FB] rounded-t-md">
          <div>
            <h3 className="text-[18px] font-bold text-[#232529]">Enrolled Students</h3>
        ...
        <div className="p-5 overflow-y-auto w-full hide-scrollbar flex-1 bg-main-bg">
          ...
          {isLoading ? (
            ...
            <div className="bg-white rounded-sm border border-[#E1E6EE] overflow-hidden shadow-sm">
                ...
                <tbody className="divide-y divide-[#E1E6EE]">
                  {students.map((student, idx) => (
                    <tr key={student.id} className="hover:bg-[#F6F8FB]/50 transition-colors">
                      ...
                      <td className="py-3 px-5 text-[13.5px] font-bold text-[#232529]">{student.name}</td>
