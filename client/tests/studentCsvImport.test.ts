...
test('parseStudentCsv accepts valid rows and maps flexible headers', () => {
  const result = parseStudentCsv(`First Name,Last Name,Email,Password,Gender,Department,Mobile No
Ram,Sharma,ram@example.com,password123,Male,CSE,9800000000
Sita,Karki,sita@example.com,password456,Female,IT,9811111111`);
